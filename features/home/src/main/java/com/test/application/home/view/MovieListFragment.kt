...
import com.test.application.home.adapter.VerticalSpaceItemDecoration
...
class MovieListFragment : Fragment() {
    ...
    private fun switchToGridLayout() {
        val (itemWidth, itemHeight) = calculateItemWidth()
        binding.rvMovieList.layoutManager = GridLayoutManager(requireContext(), 3)
    ...
    private fun addItemDecoration() {
        ...
        binding.rvMovieList.addItemDecoration(SpacingItemDecoration(spacingInPixels))
    }
    ...
    private fun switchToListLayout() {
        ...
        val verticalSpacing = resources
            .getDimensionPixelSize(com.test.application.core.R.dimen.margin_8dp_small)
        binding.rvMovieList.addItemDecoration(VerticalSpaceItemDecoration(verticalSpacing))
    }
